...
export function Messages({ fileId }: MessagesProps) {
  ...
  return (
    <div className="flex ma-h-[calc(100vh-3.5-7rem)] border-zing-200 flex-1 flex-col-reverse gap-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch">
